...
The goal of the project is to run a linear regression model using some of the key data within the dataset to find statistically significant indicators of crime. 
